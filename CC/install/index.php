...
<div class="panel panel-primary">
	<div class="panel-heading" style="background: #15A638;">
		<h3 class="panel-title" align="center">莫名cc测压系统</h3>
	</div>
...
echo <<<HTML
		...
		<input type="text" class="form-control" name="db_qz" value="lan">
...
if($e!=0) {
	echo '<div class="alert alert-success">安装成功！<br/>SQL成功'.$t.'句/失败0句</div><p align="right"><a class="btn btn-block btn-primary" href="index.php?do=5">下一步>></a></p>';
} else {
